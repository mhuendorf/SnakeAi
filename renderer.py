...
class Renderer:
    ...
    def render_scene(self, board_instance: board):
        self.dis.fill(grey)
    ...
    def draw_head(self, board_instance: board):
        ...
        if len(board_instance.snake) > 1:
            # right predecessor
            if board_instance.snake[0][0] < board_instance.snake[1][0]:
                pg.draw.rect(self.dis, green,
                             [board_instance.snake[0][0] * (self.snake_size + 1) + self.snake_size/2+1,
                              ...
                              self.snake_size/2+1,
                              (self.snake_size/3)*2])
            elif board_instance.snake[0][0] > board_instance.snake[1][0]:
                pg.draw.rect(self.dis, green,
                             [board_instance.snake[0][0] * (self.snake_size + 1),
                              board_instance.snake[0][1] * (self.snake_size + 1) + self.snake_size/6+1,
                              self.snake_size/2+1,
                              (self.snake_size/3)*2])
            elif board_instance.snake[0][1] > board_instance.snake[1][1]:
                pg.draw.rect(self.dis, green,
    ...
    def draw_tail(self, board_instance: board):
        if len(board_instance.snake) > 1:
            ...
            # right predecessor
            if board_instance.snake[tail_idx][0] < board_instance.snake[tail_idx - 1][0]:
                pg.draw.rect(self.dis, green,
                             [board_instance.snake[tail_idx][0] * (self.snake_size + 1) + self.snake_size/2+1,
                              ...
                              self.snake_size/2+1,
                              (self.snake_size/3)*2])
            elif board_instance.snake[tail_idx][0] > board_instance.snake[tail_idx - 1][0]:
                pg.draw.rect(self.dis, green,
                             [board_instance.snake[tail_idx][0] * (self.snake_size + 1),
                              board_instance.snake[tail_idx][1] * (self.snake_size + 1) + self.snake_size/6+1,
                              self.snake_size/2+1,
                              (self.snake_size/3)*2])
            elif board_instance.snake[tail_idx][1] > board_instance.snake[tail_idx - 1][1]:
                pg.draw.rect(self.dis, green,
